  ...
  export default function TableDemo() {
    ...
    const fetchData = async () => {
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_API_URL}/api/edit/entrees`,{
            method: "GET",
            headers: {
   ...
   useEffect(() => {
    ...
    return (
        <>
        <p className="font-bold text-2xl bg-purple-500 w-full p-2 text-center text-white rounded-lg">INVENTAIRE DES ENREGISTREMENTS</p>
       {isLoading ? <Loader2 className="w-14 h-14 animate-spin text-gray-500"/> : (
                  ...
                  <TableHeader>
                    <TableRow>
                      ...
                      <TableHead className="font-bold text-lg">Quantité enregistrée</TableHead>
