...
export default function SectionCards() {
  return (
    <div className=" *:data-[slot=card]:from-primary/5 *:data-[slot=card]:to-card dark:*:data-[slot=card]:bg-card grid grid-cols-1 gap-4 px-4 *:data-[slot=card]:bg-gradient-to-t *:data-[slot=card]:shadow-xs lg:px-6 md:grid-cols-2 xl:grid-cols-4">
      <Card className="@container/card border-e-purple-700">
        <CardHeader>
      ...
      <Card className="@container/card border-yellow-500">
        <CardHeader>
      ...
      <Card className="@container/card border-red-700">
        <CardHeader>
      ...
      <Card className="@container/card border-b-blue-700 ">
        <CardHeader>
